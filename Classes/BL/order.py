# ------------------------ Food CLass ------------------------------ #
class Order():
    def __init__(self,order_name,order_id,order_date,order_address,ordered_items,ordered_items_count,order_total_price):
    ...
    # ------------------------ Setter ------------------------------ #
    @order_name.setter
    def order_name(self,order_name:str)->None:
        self.__order_name = order_name
